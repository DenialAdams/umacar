# Lifted from https://github.com/Euophrys/umamusume-tierlist/blame/main/db-convert.py
# output format slightly modified. adjusted for global ala https://github.com/Euophrys/umamusume-tierlist/blob/main/src/global/db-convert.py
    ...
    for data in card_data:
        ...
        for i in range(5):
            ...
            if unique is not None:
                for u in range(0,3,2): # modified for global
